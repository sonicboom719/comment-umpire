...
YouTube動画のコメントを表示・分析するツール集です。AIを使用してコメントを詳細に分析し、16種類のカテゴリーに分類します。
...
### AI分析機能
- **16種類のカテゴリー分類**: 皮肉、嘲笑、感想、意見、アドバイス、批判、誹謗中傷、悪口、侮辱、上から目線、論点すり替え、攻撃的、賞賛、感謝、情報提供、問題提起
